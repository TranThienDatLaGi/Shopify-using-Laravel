...
@section('content')
    ...
    $currentOrder = request('order', 'asc');  // fallback mặc định
                            ...
                            <div class="dropdown-content sort-menu">
                                ...
                                <label>
                                    <input type="radio" name="sort" value="created" {{ $currentSort === 'created' ? 'checked' : '' }}>
                                    Created At
                                </label>
                                <label>
                                ...
                                <label>
                                    <input type="radio" name="sort" value="vendor" {{ $currentSort === 'vendor' ? 'checked' : '' }}>
                                    Vendor
                                </label>
            ...
            <script>
                ...
                async function applyFilters(cursor = "", direction = "") {
                    ...
                    try {
                        ...
                        const tableContainer = document.getElementById("productTableBody");
